...
\section[Design]{DSL Design}
    ...
    \begin{frame}
        ...
        The hallway leads to another door.
...
%    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{block}{But \textit{whattabout}...?}
            \begin{itemize}
...
\section[Case Study 1]{Case Study 1 --- TTRPG ``dice expressions''}
    ...
    \begin{frame}
        ...
        \pause
        \begin{block}{But \textit{whattabout} the users?}
            It's a \texttt{*}.
    ...
    \begin{frame}[fragile]
        \frametitle{The \texttt{Dice} class}
...
\section[Case Study 2]{Case Study 2 --- \textbf{OpenD6} spells}
    ...
    \begin{frame}
        ...
        \uncover<3->{A (second) bulk coversion was required.}
...
\section{Conclusion}
    ...
    \begin{frame}
        ...
        \vspace{\baselineskip}
        \begin{center}
        \textbf{Pursue Pythonic Practices}
        \end{center}
    \end{frame}
...
\subsection{Malicious Actors}
    ...
    \begin{frame}
        ...
        \begin{block}{Are \textbf{all} elements present?}
            \begin{itemize}
                \item Untrusted sources of DSL, and
                \item Large DSL docs, and
                \item Difficulty in doing code validation.
            \end{itemize}
        \end{block}
